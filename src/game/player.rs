...
impl Player {
    pub fn new() -> Player {
        Player {
            ...
            vel: Vector2::zeros(), cam_plane: Vector2::new(-1.0, 0.0), head_bob_amount: 0.0 }
    }
    ...
    pub fn step(&mut self, dir: Vector2<f64>, delta: f64) {
        ...
        self.head_bob_amount = (self.head_bob_amount + self.vel.magnitude().min(1.0) * delta * 20.0).rem_euclid(PI*2.0);
